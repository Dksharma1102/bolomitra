...
import { Heart, MessageCircle, X, Mic, Volume2 } from 'lucide-react';
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-3xl p-8 w-full max-w-2xl max-h-[80vh] overflow-hidden shadow-2xl"
          >
            {/* Header */}
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-coral-pink">
                  <img
                ...
                <div>
                  <h2 className="text-xl font-bold text-slate-700">Hug Mode 🤗</h2>
                  <p className="text-sm text-slate-600">Comforting conversations with {selectedAvatar?.name || 'your companion'}</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="mb-6">
              <p className="text-sm text-slate-600 mb-3">Quick voice messages:</p>
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-slate-100 hover:bg-coral-pink hover:text-white rounded-full text-sm transition-colors duration-300 flex items-center gap-2"
                  >
                    <Mic size={14} />
                    {msg}
                  </button>
            ...
            <motion.div
              ...
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none text-6xl opacity-10"
            >
              🤗
            </motion.div>
          </motion.div>
